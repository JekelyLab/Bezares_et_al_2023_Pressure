...
# About the project: 
- this is a repository from the [Jékely lab](https://www.cos.uni-heidelberg.de/en/research-groups/gaspar-jekely) containing source data and code documentation for the paper [Mechanism of barotaxis in marine zooplankton.](    https://doi.org/10.7554/eLife.94306.1)

This repository contains the data and code for our paper:

> Luis Alberto Bezares Calderón, Réza Shahidi, Gáspár Jékely. _`r Title`_. eLife <    https://doi.org/10.7554/eLife.94306.1>
...
> Authors, (`r format(Sys.Date(), "%Y")`). _Code and source data for `r Title`_. Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at <(https://zenodo.org/doi/>
